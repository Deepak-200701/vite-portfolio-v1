const Projects = () => {
    return (
        <div className="rn-portfolio-area rn-section-gap section-separator" id="projects">
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="section-title text-center">
                            <h4 className="maintitle" style={{ color: "#F7024E" }}>MY PROJECTS</h4>
                        </div>
                    </div>
                </div>
                ...
                <div className="row row--25 mt--10 mt_md--10 mt_sm--10">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true"
                        ...
                        <div className="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail" style={{ overflow: "hidden", height: "250px" }}>
                                    <a href="javascript:void(0)">
                                        <img src="/src/assets/images/portfolio/portfolio-01.jpg"
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true"
                        ...
                        <div className="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail" style={{ overflow: "hidden", height: "250px" }}>
                                    <a href="javascript:void(0)">
                                        <img src="/src/assets/images/portfolio/portfolio-02.jpg"
                                            alt="Personal Portfolio Images" />
                                    </a>
                                </div>
                                <div className="content">
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true"
                        ...
                        <div className="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail" style={{ overflow: "hidden", height: "250px" }}>
                                    <a href="javascript:void(0)">
                                        <img src="/src/assets/images/portfolio/portfolio-03.jpg"
                                            alt="Personal Portfolio Images" />
                                    </a>
                                </div>
                                <div className="content">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true"
                        ...
                        <div className="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail" style={{ overflow: "hidden", height: "250px" }}>
                                    <a href="javascript:void(0)">
                                        <img src="/src/assets/images/portfolio/portfolio-04.jpg"
                                            alt="Personal Portfolio Images" />
                                    </a>
                                </div>
                                <div className="content">
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true"
                        ...
                        <div className="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail" style={{ overflow: "hidden", height: "250px" }}>
                                    <a href="javascript:void(0)">
                                        <img src="/src/assets/images/portfolio/portfolio-05.jpg"
                                            alt="Personal Portfolio Images" />
                                    </a>
                                </div>
                                <div className="content">
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true"
                        ...
                        <div className="rn-portfolio" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail" style={{ overflow: "hidden", height: "250px" }}>
                                    <a href="javascript:void(0)">
                                        <img src="/src/assets/images/portfolio/portfolio-06.jpg"
                                            alt="Personal Portfolio Images" />
                                    </a>
                                </div>
                                <div className="content">
